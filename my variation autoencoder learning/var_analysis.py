...
from var_train import load_mnist
...
if __name__ == "__main__":
    ...
    #plot image output of autoencoder
    ...
    #scatter in latent space
    num_sample_images_to_show = 6000
    sample_images, sample_labels = select_images(x_test, y_test, num_sample_images_to_show)
    _, latent_representation = autoencoder.reconstruct(sample_images)
    plot_images_encoded_in_latent_space(latent_representation, sample_labels)